...
public class VendingMachineView {
	...
	public BigDecimal getMoney() {
		return io.readBigDecimal("Please input the amount in dollars before making a selection");
	}
	...
	public String getItemSelection() {
		return io.readString("Please enter the name of an item from the menu above or type 'exit' to quit");
	}
